...
#Heading
Label(root, text="Welcome to Sukalyan's Travels", font="comicsansms 13 bold", pady=15).grid(row=0, column=3)
...
Button(text="Submit", command=getvals,bg="green",font="comicsans 12 bold").grid(row=11, column=3)
